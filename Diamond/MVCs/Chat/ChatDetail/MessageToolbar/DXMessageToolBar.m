...
- (void)setupSubviews
{
    ...
    [self.styleChangeButton setImage:[UIImage imageNamed:@"chat_details_icon_yuying"] forState:UIControlStateNormal];
    [self.styleChangeButton setImage:[UIImage imageNamed:@"chat_details_icon_jianpan"] forState:UIControlStateSelected];
    ...
    [self.moreButton setImage:[UIImage imageNamed:@"chat_details_icon_genduo"] forState:UIControlStateNormal];
    [self.moreButton setImage:[UIImage imageNamed:@"chat_details_icon_genduo"] forState:UIControlStateHighlighted];
    [self.moreButton setImage:[UIImage imageNamed:@"chat_details_icon_jianpan"] forState:UIControlStateSelected];
    ...
    [self.faceButton setImage:[UIImage imageNamed:@"chat_details_icon_biaoqing"] forState:UIControlStateNormal];
    [self.faceButton setImage:[UIImage imageNamed:@"chat_details_icon_biaoqing_se"] forState:UIControlStateHighlighted];
    [self.faceButton setImage:[UIImage imageNamed:@"chat_details_icon_jianpan"] forState:UIControlStateSelected];
...
//    self.inputTextView.contentMode = UIViewContentModeCenter;
    ...
    if (!self.faceView) {
        ...
        self.faceView.backgroundColor = UIColorFromRGB(0xfafafa);
